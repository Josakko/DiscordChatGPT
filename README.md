...
2. Download executable file [here](https://www.mediafire.com/file/ckxfj8d4vvfwhyt/JK_ChatBot.zip/file) and unzip it (or just use index.js, but I recommend you to use executable file for simplicity).
